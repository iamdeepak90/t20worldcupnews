  ...
  return (
    <div className="container" style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <Link className="btn" style={{ width: '250px', margin: '0 atuo' }} href="/">Go to Homepage ↗</Link>

        <div style={{ marginTop: '20px' }}>
          <h3 style={{ fontSize: '1.2rem'}}>
           Check our popular pages:
          </h3>
          <ul style={{ listStyle: 'none', display: 'flex', gap: '1rem', padding: 0 }}>
            <li>
              <Link href="/t20-world-cup-schedule-list">
                T20 World Cup 2026 Schedule
              </Link>
            </li>
            <li>
              <Link href="/team-squads">
                Teams & Squads
              </Link>
            </li>
            <li>
              <Link href="/t20-world-cup-predictions">
                Match Predictions
              </Link>
            </li>
          </ul>
